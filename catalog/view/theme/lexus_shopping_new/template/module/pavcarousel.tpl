...
$span = floor(12/$columns);
	$columns_count  = 1;
?>
<div id="pavcarousel" class="panel panel-default panel-v2 carousel owl-carousel-play pavcarousel" data-ride="owlcarousel">
	...
	<div class="carousel-content">
		...
		<?php if( count($banners) > $itemsperpage ){ ?>	
			...
			<a class="carousel-control left carousel-md" href="#pavcarousel<?php echo $id;?>" data-slide="prev">
				<i class="fa fa-angle-left"></i>
			</a>
			<a class="carousel-control right carousel-md" href="#pavcarousel<?php echo $id;?>" data-slide="next">
