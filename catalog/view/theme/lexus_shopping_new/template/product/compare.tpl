   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input style="margin: 5px;" type="button" value="<?php echo $button_cart; ?>" class="btn btn-xs btn-success" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
            <a style="margin: 5px;" href="<?php echo $product['remove']; ?>" class="btn btn-xs btn-success"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      </div>
